...
define('library-app/tests/app.lint-test', [], function () {
  ...
  QUnit.test('models/subscriber.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/subscriber.js should pass ESLint\n\n');
  });
...
define('library-app/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('unit/models/subscriber-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/models/subscriber-test.js should pass ESLint\n\n');
  });
...
define('library-app/tests/unit/controllers/about-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('library-app/tests/unit/models/subscriber-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Model | subscriber', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
